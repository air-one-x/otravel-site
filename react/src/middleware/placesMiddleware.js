...
export default (store) => (next) => (action) => {
    switch (action.type) {
        ...
        axios({
            method: 'post',
            url: 'http://ec2-3-86-88-131.compute-1.amazonaws.com/api/places',
        ...
        case CHECK_FILTER:
            ...
            axios({
                method: 'post',
                url: `http://ec2-3-86-88-131.compute-1.amazonaws.com/api/category/places/${store.getState().placesReducer.filter}`,
